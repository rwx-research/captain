...
type TaskRunner struct {
	MockNewCommand             func(ctx context.Context, name string, args ...string) (exec.Command, error)
...
func (t *TaskRunner) NewCommand(ctx context.Context, name string, args ...string) (exec.Command, error) {
	if t.MockNewCommand != nil {
		return t.MockNewCommand(ctx, name, args...)
	}
