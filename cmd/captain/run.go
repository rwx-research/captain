			...
			err := func() error {
				...
				if suiteConfig, ok := cfg.TestSuites[cliArgs.RootCliArgs.suiteID]; ok {
					...
					runConfig = cli.RunConfig{
						...
						MintErrorsDirectory:       os.Getenv("MINT_ERRORS"),
						MintRetryActionsDirectory: os.Getenv("MINT_RETRY_ACTIONS"),
						MintRetryDataDirectory:    os.Getenv("MINT_RETRY_DATA"),
						MintRetryFailedTests:      os.Getenv("CAPTAIN_MINT_RETRY_FAILED_TESTS") == "true",
